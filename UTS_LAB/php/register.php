...
<body class="p-6 poppins-regular">
    ...
    <h1 class="text-3xl text-center font-bold text-[#1E3A8A] mt-12">Hello! We're so glad to meet you ! </h1>
    <div class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-10">

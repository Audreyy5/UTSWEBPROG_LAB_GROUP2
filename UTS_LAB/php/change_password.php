...
<body class="bg-amber-100 flex items-center justify-center h-screen p-4 poppins-regular">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm text-center">
        <a href="profile.php" class="text-blue-500 hover:text-blue-700 font-bold mb-4 inline-block">&larr; Back</a>
        <h2 class="text-2xl font-bold mb-6">Change Password</h2>

        <form action="change_password.php" method="POST" onsubmit="return validatePassword()">
            <div class="mb-4 relative">
                <label for="new_password" class="block text-gray-700 text-left mb-2">New Password:</label>
            ...
            <div class="mb-6 relative">
                <label for="confirm_password" class="block text-gray-700 text-left mb-2">Confirm Password:</label>
